...
{
	public class AdvancedSlider : AdvancedSelectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            else if(m_HandleContainerRect != null && RectTransformUtility.RectangleContainsScreenPoint(m_HandleContainerRect, eventData.pointerPressRaycast.screenPosition, eventData.enterEventCamera))
            {
